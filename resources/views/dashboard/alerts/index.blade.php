...
<div class="card shadow mb-6">
  ...
  <div class="card-header py-3">
    ...
    <div class="row col-12">
      ...
      <div class="col-6">
        <h6 class="m-0 font-weight-bold text-primary btn-icon-split align-bottom">Lista de alertas publicadas en la página web</h6>
      </div>


      <div class="col-6">
        <!-- Utilizo el metodo CREATE del controlador de User-->
        <a href="{{route('dashboard::createAlert')}}" class="btn btn-success btn-icon-split float-right">
          <!-- Le meto un simbolo de +, con una luminosidad del 50%-->
          <span class="icon text-white-50">
            <i class="fas fa-plus"></i>
          </span>

          <span class="text">Nueva Alerta</span>
        </a>
      </div>
            ...
            @foreach ($items as $index => $item)
              <tr>
                ...
                <td>
                  ...
                  <a  href="{{ route('dashboard::alerts.toggleAccess1', ['user' => $item->id, 'type' => 'status', 'page' => $page]) }}" 
                ...
                <td>
                  ...
                  <!-- 'type' el campo de la base de datos 'status'-->
                  <!-- 'page' contiene a la variable 'page'-->
                  <a  href="{{ route('dashboard::alerts.toggleAccess1', ['user' => $item->id, 'type' => 'public', 'page' => $page]) }}" 

                    data-toggle="tooltip" data-placement="top" title="" class="status-icons d-flex justify-content-center" data-original-title="Acceder a la web">

                    <!--Le meto un Fa Icon con un IF para cambiarlo ON/OFF--> 
                    <i class="fa @if( $item->public ) fa-toggle-on @else fa-toggle-off @endif fa-2x"></i>
                  </a>
                </td>
                <!--------------------------------------->
                <!------------ BOTONES ------------------>
                <td class="d-flex justify-content-center">
                  ...
                  <!------------ EDIT ------------------>
                  <a href="{{ route('dashboard::editAlert', ['alert' => $item->id, 'page' => $page]) }}" class="btn btn-info btn-circle btn-sm" title="Editar" style="margin:1px">
                    <span class="icon">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('dashboard::alertDelete', ['user' => $item->id])}}" title="Eliminar" style="margin:1px" method="post">
                                    @csrf
                                    {{method_field('DELETE')}}
