        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <form action="{{ route('dashboard::categorias.store') }}" method="post" enctype="multipart/form-data" class="col-lg-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="description" value="{{old('description')}}" />
                        </div>
