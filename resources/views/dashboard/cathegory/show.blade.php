...
<!-- ----------------CARD--------------------- -->
          ...
          <div class="card-header py-3">
           <h5 style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : ''}}"><strong>Área de extranjería:</strong> </h5> <button class="btn btn-info">{{$cathegories->name}}</button>
          </div>
          ...
          <table id="datatable-responsive" class="table table-striped  dt-responsive display" style="width: 100%">
            ...
            <thead>
              <tr>
                ...
                <th>Lista de servicios en esta categoría</th>
                <th>Acciones</th>
              </tr>
            </thead>
           <!--Aqui tomo la variable ('folders') que cree en el metodo Index
