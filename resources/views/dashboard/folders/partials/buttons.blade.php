                <a href="{{ route('dashboard::productos.show', $product->id) }}" class="btn btn-success btn-circle btn-sm" title="download" style="margin:1px">
                    <span class="icon">
...
<!----------------------------DELETE-------------------------------------->
                ...
                <a href="#victorModal{{$product->id}}" role="button" class="btn btn-danger btn-circle" data-toggle="modal" style="width: 30px;height: 30px;">
                    <span class="icon">
                ...
                <div id="victorModal{{$product->id}}" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('dashboard::productos.destroy', [$product->id])}}" title="Eliminar" style="margin:1px" method="post">
                                    @csrf
                                    {{method_field('DELETE')}}
