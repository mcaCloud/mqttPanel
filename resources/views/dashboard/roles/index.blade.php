                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="text-danger"style="text-align: justify">
                                  <small >Este role será eliminado directamente de la base de datos junto con toda su información.</small>
                                </p>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('dashboard::roles.destroy', ['role' => $item->id])}}" title="Eliminar" style="margin:1px" method="post">
                                    @csrf
                                    {{method_field('DELETE')}}
