...
<div class="card shadow mb-6">
  ...
  <div class="card-header py-3">
    ...
    <div class="row col-12">
      ...
      <div class="col-6">
        <h6 class="m-0 font-weight-bold text-primary btn-icon-split align-bottom">Lista de videos publicados en la página web</h6>
      </div>


      <div class="col-6">
        <!-- Utilizo el metodo CREATE del controlador de User-->
        <a href="{{route('dashboard::createVideo')}}" class="btn btn-success btn-icon-split float-right">
          <!-- Le meto un simbolo de +, con una luminosidad del 50%-->
          <span class="icon text-white-50">
            <i class="fas fa-plus"></i>
          </span>

          <span class="text">Nuevo Video</span>
        </a>
      </div>
            ...
            @foreach ($items as $index => $item)
              <tr>
                ...
                <td>
                  ...
                  <a  href="{{ route('dashboard::videos.toggleAccess', ['user' => $item->id, 'type' => 'status', 'page' => $page]) }}" 
                ...
                <td class="d-flex justify-content-center">
                  ...
                  <!------------ EDIT ------------------>
                  <a href="{{ route('dashboard::editVideo', ['doc' => $item->id, 'page' => $page]) }}" class="btn btn-info btn-circle btn-sm" title="Editar" style="margin:1px">
                    <span class="icon">
